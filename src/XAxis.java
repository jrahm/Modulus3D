...
/*     */   private Color color;
/*     */ 
/*     */   public XAxis(double xoff, double yoff, double zoff, double rotX, double rotY, double rotZ, CoordinateSystem graph, Color color)
/*     */   {
...
/*  96 */     this.color = color;
/*     */   }
/*     */   private static Point3D transpose(double y, double z, double x) {
